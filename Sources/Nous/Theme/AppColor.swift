...
struct AppColor {
    ...
    static let sidebarGlassVeil = dynamicColor(
        light: NSColor(red: 1, green: 253/255, blue: 248/255, alpha: 0.36),
    ...
    static let composerInputGlassTint = sidebarGlassTint
    static let composerInputGlassOverlay = sidebarGlassVeil
    static let composerInputGlassStroke = sidebarGlassStroke
    static let composerMenuGlassTint = composerInputGlassTint
    static let composerMenuGlassOverlay = composerInputGlassOverlay
    static let composerMenuGlassStroke = composerInputGlassStroke
